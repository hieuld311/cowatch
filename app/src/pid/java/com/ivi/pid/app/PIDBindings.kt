...
abstract class PIDBindings {
    @Binds
    abstract fun bindPlaybackController(implementation: Media3PlaybackController): PlaybackController

    @Binds
    abstract fun bindPlayerSurfaceController(implementation: Media3PlaybackController): PlayerSurfaceController
}
